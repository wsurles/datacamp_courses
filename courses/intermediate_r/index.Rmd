...
# Introduction
  ...
  - This all comes from the [Intermediate R](https://www.datacamp.com/courses/intermediate-r) course on DataCamp
    ...
    - Go do the course for yourself to get more details and videos on these topics
...
## For loop
  ...
  - Execute a statement, changing a variable each time.
  ...
  - However I never use loops in R
    - I always modify data with array functions. They are WAY faster
    - dplyr and other similar libraries do the looping in C
...
Whats true about the `read.table()` function?
...
### Function scoping
  ...
  - variable defined inside a function are not available outside of that function
  - neither are the variable names given to the input
...
## R Packages
  ...
  - all the functions you use that are not in the workspace are in a package
  - the base package is installed with R and loaded with you start R
  - other packages you need to install and load when you want to use their functions
  - Most of the functions I use are from key packages
    - There are some very powerful packages
    - Especially the 'hadleyverse', or packages written by hadley wickham. 
    - They will make your life easy and your work go well. Learn them all. 

```{r}
## We first need to make sure our packages are installed
## 
```
